  ...
  return (
    <section className="bg-muted">
      ...
      <Container>
        ...
        >
          <div className="mt-5 flex w-full max-w-[40em] items-center justify-center">
          ...
          <section className="mt-12 flex h-52 flex-col items-center">
            ...
            <button
              onClick={sendPing}
              className={`cursor-pointer rounded-md bg-primary px-2.5 py-1.5 ${status === "loading" ? "hidden" : "visible"}`}
            >
